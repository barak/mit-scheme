...
$Id: pros2pm.c,v 1.14 1995/11/04 01:53:35 cph Exp $
...
DEFINE_PRIMITIVE ("OS2WIN-SET-POINTER", Prim_OS2_window_set_pointer, 2, 2, 0)
{
  PRIMITIVE_HEADER (2);
  PRIMITIVE_RETURN
    (BOOLEAN_TO_OBJECT
     (OS2_window_set_pointer ((wid_argument (1)), (arg_ulong_integer (2)))));
}

