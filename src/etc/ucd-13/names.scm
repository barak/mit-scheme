...
("EBase" emoji-modifier-base boolean)
("EComp" emoji-component boolean)
("EMod" emoji-modifier boolean)
("Emoji" emoji boolean)
("EPres" emoji-presentation boolean)
("Ext" extender boolean)
("ExtPict" extended-pictographic boolean)
("FC_NFKC" fc-nfkc-closure code-point+)
("GCB" grapheme-cluster-break
 (enum "CN" "CR" "EX" "L" "LF" "LV" "LVT"
       "PP" "RI" "SM" "T" "V" "XX" "ZWJ"))
("GCB+EP" grapheme-cluster-break+ext-pict
 (enum "CN" "CR" "EX" "L" "LF" "LV" "LVT"
       "PP" "RI" "SM" "T" "V" "XX" "XX+EP" "ZWJ"))
...
("WB" word-break
 (enum "CR" "DQ" "EX" "Extend" "FO" "HL" "KA" "LE" "LF" "MB"
       "ML" "MN" "NL" "NU" "RI" "SQ" "WSegSpace" "XX" "ZWJ"))
("WB+EP" word-break+ext-pict
 (enum "CR" "DQ" "EX" "Extend" "FO" "HL" "KA" "LE" "LE+EP" "LF" "MB"
       "ML" "MN" "NL" "NU" "RI" "SQ" "WSegSpace" "XX" "XX+EP" "ZWJ"))
...
("age" age
 (enum "1.1" "2.0" "2.1" "3.0" "3.1" "3.2" "4.0" "4.1" "5.0" "5.1" "5.2"
       "6.0" "6.1" "6.2" "6.3" "7.0" "8.0" "9.0" "10.0.0" "11.0.0"
       "12.0.0" "12.0.1" "13.0.0" "unassigned"))
...
("jg" joining-group
 (enum "African_Feh" "African_Noon" "African_Qaf"
       ...
       "Hamza_On_Heh_Goal" "He" "Heh" "Heh_Goal" "Heth"
...
("sc" script
 (enum "Adlm" "Aghb" "Ahom" "Arab" "Armi" "Armn" "Avst"
       ...
       "Cakm" "Cans" "Cari" "Cham" "Cher" "Chrs" "Copt" "Cprt" "Cyrl"
       ...
       "Qaai"
       "Rjng" "Rohg" "Runr"
       "Samr" "Sarb" "Saur" "Sgnw" "Shaw" "Shrd" "Sidd" "Sind"
       "Sinh" "Sogd" "Sogo" "Sora" "Soyo" "Sund" "Sylo" "Syrc"
